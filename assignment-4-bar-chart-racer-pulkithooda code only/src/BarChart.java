...
import java.util.TreeMap;
    ...
    public class BarChart {
        ...
        public static void main(String[] args) {
            ...
            String title = "Some of the 10 highest grossing movies in 1982";
            String xAxis = "Revenue";
            String source = "Source: Box Office Mojo";
            BarChart chart = new BarChart(title, xAxis, source);
            chart.setCaption("1982");

            // add the bars to the bar chart
            chart.add("Dalmations", 51000000, "Buena Vista");
            chart.add("Absence of Malice", 20051405, "Sony / Columbia");
            chart.add("Empire Strikes Back", 209398025, "20th Century Fox");
            chart.add("Raiders of the Lost Ark", 180089481, "Paramount");
            chart.add("The Godfather", 133698921, "Paramount");
            chart.add("The Exorcist", 193000000, "Warner Bros.");
            chart.add("Jaws", 260000000, "Universal");
            chart.add("Bambi", 40200000, "RKO");
            chart.add("Jungle Book", 73741048, "Buena Vista");
